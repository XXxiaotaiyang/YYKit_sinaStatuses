...
- (void)_layout {
    ...
    _titleHeight = 0;  // 标题栏高度
    _profileHeight = 0;  // 个人资料高度
    _textHeight = 0;    //文本高度(包括下方留白)
    _retweetHeight = 0; //转发高度，0为没转发
